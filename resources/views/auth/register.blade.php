                    ...
                    <div class="panel-body">
                        ...
                        @guest
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="form-group{{ $errors->has('birthDate') ? ' has-error' : '' }}">
                                    <label style="color: black" for="birthDate" class="col-md-4 control-label">Birth
                                        Date</label>
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                    <label style="color: black" for="email" class="col-md-4 control-label">E-Mail
                                        Address</label>
                                ...
                                <div class="form-group{{ $errors->has('schooling') ? ' has-error' : '' }}">
                                    <label style="color: black" for="schooling"
                                           class="col-md-4 control-label">Schooling</label>
                                ...
                                <div class="form-group{{ $errors->has('picture') ? ' has-error' : '' }}">
                                    <label style="color: black" for="picture"
                                           class="col-md-4 control-label">Picture</label>
                                ...
                                <div class="form-group">
                                    <label style="color: black" for="password-confirm" class="col-md-4 control-label">Confirm
                                        Password</label>
