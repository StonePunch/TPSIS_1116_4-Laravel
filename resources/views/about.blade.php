    ...
    <section id="aboutUs">
        <div class="container">
            <div class="heading text-center">
                ...
                <p style="color: white">At lorem Ipsum available, but the majority have suffered alteration in some form by injected humour.</p>
            </div>
            <div class="row feature design">
                <div class="area1 columns left">
                    <h3 style="color: white">Our Design tells about quality</h3>
                    ...
                    <p style="color: white">Odio quaeque reformidans est eu, expetendis intellegebat has ut, viderer invenire ut his. Has molestie percipit an. Falli volumus efficiantur sed id, ad vel noster propriae. Ius ut etiam vivendo, graeci iudicabit constituto at mea. No soleat fabulas prodesset vel, ut quo solum dicunt.
            ...
            <div class="row dataTxt">
                <div class="col-md-4 col-sm-6">
                    <h3 style="color: white">Our Education</h3>
                    <p style="color: white">Lorem ipsum dolor consectetursit amet, consectetur adipiscing elit consectetur euismod </p>
